...
(function() {
  ...
  var Lightbox = (function() {
    ...
    Lightbox.prototype.build = function() {
      var self = this;
      obj=self;
      $("<div id='lightboxOverlay' class='lightboxOverlay'><p style='position: absolute;width: 100%;height: 100%; text-align: center;font-size: 30px' id='loadin'>加载中！</p></div><div id='lightbox' class='lightbox'><div class='lb-dataContainer'><div class='lb-data'><div class='lb-details'><span class='lb-caption'></span><span class='lb-number'></span></div><div class='lb-closeContainer'><a class='lb-close'></a></div></div></div><div class='lb-outerContainer'><div class='lb-container'><img class='lb-image' src=''/><div class='lb-nav'><a class='lb-prev' href=''></a><a class='lb-next' href=''></a></div><div class='lb-loader'><a class='lb-cancel'></a></div></div></div></div>").appendTo($('body'));
    ...
    function changeImg(){
      ...
      if(isapple()!=1){
        client.y=$(window).height();
        client.x=$(window).width();
      }else{
        client.y=window.screen.height;
        client.x=window.screen.width;
      }
      var imgs=$("ul li img");
      var imgsrcs=[];
      $.each(imgs,function(){
