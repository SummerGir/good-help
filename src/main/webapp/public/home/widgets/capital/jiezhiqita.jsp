...
<div class="capital" name="jiezhiqita">
    <div class="cap">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            data : {project_ids : project_ids_operate.join(";"),type:'其他-借支'},
            dataType : "json",
            success : function(msg){
                $(".capital[name='jiezhiqita'] .profit span").text(parseFloat(msg[0].toFixed(2)).toLocaleString());
            }
        });
    });
</script>
