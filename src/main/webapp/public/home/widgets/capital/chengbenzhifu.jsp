...
<div class="capital" name="chengbenzhifu">
    <div class="cap">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            data : {project_ids : project_ids_operate.join(";"),type:'成本支付'},
            dataType : "json",
            success : function(msg){
                $(".capital[name='chengbenzhifu'] .profit span").text(parseFloat(msg[0].toFixed(2)).toLocaleString());
                $(".capital[name='chengbenzhifu'] .profit-ratio span").text(msg[1]);
            }
        });
    });
</script>
