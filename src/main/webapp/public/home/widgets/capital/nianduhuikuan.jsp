...
<div class="capital" name="nianduhuikuan">
    <div class="cap">
        <div class="tubiao" style="background-color: #166de4;">
            <i class="icon iconfont icon-nianduhuikuan"></i>
        </div>
        <div class="content">
            <span class="name">年度回款</span>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            data : {project_ids : project_ids_operate.join(";"),type:'年度回款'},
            dataType : "json",
            success : function(msg){
                $(".capital[name='nianduhuikuan'] .profit span").text(parseFloat(msg[0].toFixed(2)).toLocaleString());
            }
        });
    });
</script>
