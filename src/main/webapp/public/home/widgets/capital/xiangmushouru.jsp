...
<div class="capital" name="xiangmushouru">
    <div class="cap">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            data : {project_ids : project_ids_operate.join(";"),type:'项目收入'},
            dataType : "json",
            success : function(msg){
                $(".capital[name='xiangmushouru'] .profit span").text(parseFloat(msg[0].toFixed(2)).toLocaleString());
                $(".capital[name='xiangmushouru'] .profit-ratio span").text(msg[1]);
            }
        });
    });
</script>
