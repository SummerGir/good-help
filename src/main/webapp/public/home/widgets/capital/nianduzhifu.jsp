...
<div class="capital" name="nianduzhifu">
    <div class="cap">
        <div class="tubiao" style="background-color: #f87e1b;">
            <i class="icon iconfont icon-nianduzhifu"></i>
        </div>
        <div class="content">
            <span class="name">年度支付</span>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            data : {project_ids : project_ids_operate.join(";"),type:'年度支付'},
            dataType : "json",
            success : function(msg){
                $(".capital[name='nianduzhifu'] .profit span").text(parseFloat(msg[0].toFixed(2)).toLocaleString());
            }
        });
    });
</script>
