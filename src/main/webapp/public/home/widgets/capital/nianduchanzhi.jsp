...
<div class="capital" name="nianduchanzhi">
    <div class="cap">
        <div class="tubiao" style="background-color: #f34541;">
            <i class="icon iconfont icon-nianduchanzhi"></i>
        </div>
        <div class="content">
            <span class="name">年度产值</span>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            data : {project_ids : project_ids_operate.join(";"),type:'年度产值'},
            dataType : "json",
            success : function(msg){
                $(".capital[name='nianduchanzhi'] .profit span").text(parseFloat(msg[0].toFixed(2)).toLocaleString());
            }
        });
    });
</script>
