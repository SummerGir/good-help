...
<div class="capital" name="zijinjinge">
    <div class="cap">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            data : {project_ids : project_ids_operate.join(";"),type:'资金净额'},
            dataType : "json",
            success : function(msg){
                $(".capital[name='zijinjinge'] .profit span").text(parseFloat(msg[0].toFixed(2)).toLocaleString());
            }
        });
    });
</script>
