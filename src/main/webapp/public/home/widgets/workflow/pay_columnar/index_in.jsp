...
<div class="widget-charts">
    <%
        ...
        String content_url = "";
        AppTreeNode appTreeNode = CurrentApplicationTemplate.getAppTreeNodeByCode("xmzjsrbb"); //按资源代码获取资源
        if (appTreeNode != null) {
    ...
    <div class="widget-charts-panel" style="padding: 2px;">
        <div class="col-xs-8 col-md-8 col-md-offset-2 col-xs-offset-2" style="position:absolute; z-index: 1">
            <select  id="objectId" onchange="loadBar()" class="select2" multiple style="width: 100%;">
                <%=sb.toString()%>
            </select>
        </div>
        <div id="pay_columnar"  style="max-width: 100%; min-height: 200px;"></div>
    </div>
    <script type="text/javascript">
        ...
        function loadBar(){
            ...
            $.getJSON("/public/home/sheet/plug_in_action.jsp",{action:"plugProjectMoneyIn",ids:objectIds},function(res){
                require([
                            'echarts',
                            'echarts/chart/bar'
                        ],
