(function ($, undefined) {
    ...
    var uploadJs = "document.upload.html5.js?v="+Math.random();

    $.fn.document.addSupportComponent({
        css: [$.fn.document.basePath + "document.upload.css"],
        js: ["/public/js/exif.js",$.fn.document.basePath + uploadJs,'/public/controls/document/hammer.min.js','/public/controls/document/hammerManager.js?n'+Math.random(),'/public/utilities/swiper/3.3.1/js/swiper.min.js']
    });
