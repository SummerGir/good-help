KindEditor.plugin('flow_radiobox', function (K) {
    var editor = this, name = 'flow_radiobox';
    editor.plugin.flow_radiobox = {
        edit: function () {
            var html = [
            ...
            var dictionary_code = "";
            var style="";
            var str = editor.plugin.getSelectedflow_radiobox();
            if (str) {
    ...
    editor.clickToolbar(name, function () {
        if (judge()) {
            editor.plugin.flow_radiobox.edit();
        }
    });
