    ...
    ChosenEditor.prototype.open = function (keyboardEvent) {
        ...
        if (options.data && options.data.length) {
            for (var i = 0; i < options.data.length; i++) {
                ...
                el.attr("pinyin", options.data[i].pinyin);
        ...
        CurrentChosenEditorEntity = this;
        if(!CurrentChosenEditorEntity.instance.eiis_map){
            CurrentChosenEditorEntity.instance.eiis_map={};
        }
        var self = this;
        setTimeout(function () {
