(function ($, undefined) {
    ...
    var _document = function (element, option) {
        ...
        var addGlobalPlugin = function (name) {
            ...
            $.fn.document.addSupportComponent("EIIS.Common.controls.document_new.plugins." + name);
        };
        ...
        if (self.option.canNew === true
            ...
            if ("all".equalsIgnoreCase(self.option.plugins)) {
                $.fn.document.addSupportComponent("EIIS.Common.controls.document_new.plugins.all");
        ...
        if (self.option.canUpload === true) {
            $.fn.document.addSupportComponent("EIIS.Common.controls.document_new.upload");
        }
