...
<style type="text/css">
    ...
    @media all and (max-width:979px){
        .my-footer, .modal-overflow .my-footer{
            position: fixed;
            right: 20%;
            left: 19%;
            width: 60% !important;
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if(EIIS.browser.phone){
            ...
            $("#<%=selectorId%>-body").css("min-height",height-46+"px");
        }
        $("#<%=selectorId%>-body").css("padding-bottom",$("#<%=selectorId%>-footer").outerHeight(true)+90+"px");
    })
</script>
