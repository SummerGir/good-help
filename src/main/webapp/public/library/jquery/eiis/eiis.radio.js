...
//                return;
//            }
//            this.element.children('input:radio').each(function(i,o){
//                self._buttons.push($(o));
//                self._setOption("disabled",self.options.disabled);
//                return;
//            });
//            if(this.element.children('input:radio').length > 0){
...
//                self._buttons.push($(o));
//            });
//            this.element.buttonset().children("input:radio").each(function(i,o){
//                self._buttons.push($(o));
//            });
        ...
        _newItem:function(id,name,text,value){
            ...
            var html = String.format(
                '<input type="radio" id="{1}{0}" name="{1}" value="{2}" {3} /><label for="{1}{0}">{4}</label>'
