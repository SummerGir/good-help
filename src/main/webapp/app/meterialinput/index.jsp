                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3 col-md-3">
                                <h5>编号:</h5>
                                <input type="text" class="form-control" name="number" placeholder="请填写编号：" required="required">
                            </div>
                            <div class="col-xs-3 col-md-3">
                                <h5>例外:</h5>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-12">
                                <h5>备注说明:</h5>
                                <textarea rows="3" class="form-control" name="content" placeholder="备注说明："></textarea>
                            </div>
                        </div>
                    </div>
