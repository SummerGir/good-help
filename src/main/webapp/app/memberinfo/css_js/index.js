...
var option = {
    ...
    url:"/core/memberInfo/getMainInfo.do",//表格请求的路径
    data:{},//请求的参数
    isPage:false,//不分页
    columns:[
        {name:'memberName',title:"用户名称",align:'left'},
        {name:'photo',title:'用户头像',align:'left'},
        {name:'account',title:"登录账号",align:'left',width:'20%'},
        {name:'password',title:"登录密码",align:'left'},
        {name:'isFrozen',title:"是否冻结",align:'center',width:'20%'}
    ...
    $.message({
        ...
        ,result:function(result){
            if(result == $.message.result.yes){
                $.post("/core/memberInfo/deleteMain.do", {
...
function save_main(){
    ...
    if(!flag) return;
    $.ajax({
        url:"/core/memberInfo/saveMain.do",  //请求路径
        data:postData, //请求参数
        type:"post", //请求方式
