...
-- 正在导出表  good-helper.core_menu_tree_info 的数据：~7 rows (大约)
...
INSERT INTO `core_menu_tree_info` (`MENU_ID`, `MENU_LEVEL`, `OUTLINE_LEVEL`, `TITLE`, `URL_ID`, `ICON`, `TYPE`, `IS_SHOW`) VALUES
	...
	('6ae4458c-b87f-11e7-96df-64510645b30k', 5, '5', '系统管理', '', 'icon-shezhi', b'0', b'1'),
	('6ae445d5-b87f-11e7-96df-64510645b30l', 2, '5.2', '成员管理', '', 'icon-chengyuanguanli', b'1', b'1'),
	('6ae44662-b87f-11e7-96df-64510645b30c', 3, '3', '字典管理', 'b7cb93c9-b87f-11e7-96df-64510645b30l', 'icon-zidianxinxipingtai', b'1', b'1'),
	('6ae44662-b87f-11e7-96df-64510645b30n', 1, '5.1', '菜单管理', 'b7cb93c9-b87f-11e7-96df-64510645b30i', 'icon-caidan', b'1', b'1'),
	('6ae44662-b87f-11e7-96df-64510645b30o', 3, '5.3', 'bs图标库', 'b7cb93c9-b87f-11e7-96df-64510645b30j', 'icon-zidiansousuo', b'1', b'1'),
	('6ae44662-b87f-11e7-96df-64510645b30q', 4, '4', '实际收入统计', 'b7cb93c9-b87f-11e7-96df-64510645b30p', 'icon-shourukemu', b'1', b'1'),
	('b7cb93c9-b87f-11e7-96df-64510645b10p', 4, '5.4', 'esg图标库', 'b7cb93c9-b87f-11e7-96df-64510645b30o', 'icon-zidiansousuo', b'1', b'1');
...
INSERT INTO `core_menu_url_info` (`URL_ID`, `TITLE`, `CODE`, `URL`, `PARAMETER`, `SYS_TIME`) VALUES
	...
	('b7cb93c9-b87f-11e7-96df-64510645b30p', '实际收入统计', 'statement_realincome', '/app/statement/realincome/index.jsp', NULL, NULL);
